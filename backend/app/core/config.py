...
class Settings(BaseSettings):
    ...
    # Database
    DATABASE_URL: str = "postgresql+asyncpg://meeting_user:meeting_password@postgres/meeting_db"
    ...
    ENCRYPTION_KEY: bytes = b"12345678901234567890123456789012" # Stable 32-byte key
