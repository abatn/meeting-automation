...
def test_c5_default_plan_minutes_fallback():
    ...
    assert DEFAULT_PLAN_MINUTES[SubscriptionPlan.GRATUIT] == 600
    assert DEFAULT_PLAN_MINUTES[SubscriptionPlan.PRO] == 3000
    assert DEFAULT_PLAN_MINUTES[SubscriptionPlan.ENTREPRISE] == 12000
...
def test_c6_default_plan_config_fallback():
    ...
    assert DEFAULT_PLAN_CONFIG["GRATUIT"]["minutes"] == 600
    assert DEFAULT_PLAN_CONFIG["GRATUIT"]["price"] == 0.0
    assert DEFAULT_PLAN_CONFIG["PRO"]["minutes"] == 3000
    assert DEFAULT_PLAN_CONFIG["PRO"]["price"] == 99.0
    assert DEFAULT_PLAN_CONFIG["ENTREPRISE"]["minutes"] == 12000
