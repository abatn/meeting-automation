...
@pytest.mark.asyncio
async def test_mfa_setup(client: AsyncClient, db_session):
    ...
    login_response = await client.post("/api/v1/auth/login", data=form_data)
...
@pytest.mark.asyncio
async def test_mfa_verify(client: AsyncClient, db_session):
